...
const PaymentPage: React.FC<PaymentPageProps> = ({ provinceName }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.title = "CadGIS Maroc"; // Reset when leaving
    };
  }, [displayTitle]);
  ...
  return (
    <div className="payment-page-root bg-[#f8fafc] min-h-screen pb-12">
      ...
      <style>{`
        ...
        .contact-group { display: flex; justify-content: center; gap: 15px; margin-top: 20px; flex-wrap: wrap; }
        .btn-whatsapp {
      ...
      {/* DYNAMIC CENTERED HEADER SECTION */}
      <header className="site-header">
        ...
        <h1 className="h3 mb-2 font-weight-bold uppercase tracking-tighter">
          {displayTitle}
        </h1>
        <p className="small mb-0 opacity-80 font-weight-light tracking-wide">Titres fonciers | Bornes | Zonage | Limites ADM</p>
      </header>
      ...
      <div className="payment-card animate-in fade-in slide-in-from-bottom-6 duration-700">
        <div className="payment-body">
          ...
          <span className="arabic-banner">المبلغ الرمزي للحصول على بيانات إقليم {provinceName || 'المختار'} : </span>
            ...
            <div className="status-panel">
              ...
              {downloadUrl ? (
                ...
                <div className="text-muted font-weight-bold py-2 px-3 bg-white/60 rounded border border-blue-100">
                   Base de données en cours de mise à jour pour هذه المنطقة.
                </div>
              )}
            </div>
          )}
          ...
          <div className="instruction-box">
            <div className="instruction-step">
              ...
              <span>Transfèrer le montant vers le compte ci-dessus.</span>
            </div>
            <div className="instruction-step">
              <span className="instruction-num">2</span>
              <span>Envoyez le reçu sur WhatsApp</span>
            </div>
          </div>
