...
const ContactButtons: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 flex flex-col space-y-3 z-[1000] items-end">
      {/* Payment / Order Button (Small & Transparent background) */}
      <button 
        onClick={goToPayment}
      ...
      >
        <i className="fas fa-shopping-cart text-xl text-lime-400 group-hover:rotate-12 transition-transform"></i>
      </button>

      {/* Email Button Group (Sized down) */}
